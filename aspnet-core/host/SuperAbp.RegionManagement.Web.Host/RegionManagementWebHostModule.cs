...
using SuperAbp.RegionManagement.Web;
...
public class RegionManagementWebHostModule : AbpModule
{
    ...
    private void ConfigureMenu(IConfiguration configuration)
    {
        ...
        {
            options.MenuContributors.Add(new RegionManagementWebHostMenuContributor(configuration));
        });
    }
    ...
    private void ConfigureAuthentication(ServiceConfigurationContext context, IConfiguration configuration)
    {
        context.Services.AddAuthentication(options =>
            ...
            .AddAbpOpenIdConnect("oidc", options =>
            {
                ...
                options.Scope.Add("RegionManagement");
            });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<RegionManagementWebHostModule>();
        });
    }
    ...
    public override void OnApplicationInitialization(ApplicationInitializationContext context)
    {
        ...
        {
            options.SwaggerEndpoint("/swagger/v1/swagger.json", "RegionManagement API");
        });
